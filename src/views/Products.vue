...
const products = [
  ...
  },
  {
    ...
    options: "8 colors",
    imageSrc:
      "https://tailwindui.com/plus/img/ecommerce-images/category-page-02-image-card-03.jpg",
    imageAlt:
      "Eight shirts arranged on table in black, olive, grey, blue, white, red, mustard, and green.",
  },
  {
    ...
    options: "Black",
    imageSrc:
      "https://tailwindui.com/plus/img/ecommerce-images/category-page-02-image-card-04.jpg",
    imageAlt: "Front of plain black t-shirt.",
  },
  {
    id: 5,
